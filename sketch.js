...
kangaroo = createSprite(200,200,20,20)
kangaroo.addImage(kangaroo_running)
kangaroo.scale = 0.2
...
//In function draw(), Set the x-Position of the kangaroo according to the camera    
  if (gameState===PLAY){
    ...
    camera.position.y=kangaroo.position.y
...
function spawnShrubs() {
  ...
  if (frameCount % 150 === 0) {
    var shrub = createSprite(camera.position.x,330,40,40);
